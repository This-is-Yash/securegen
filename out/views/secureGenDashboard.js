...
exports.SecureGenDashboard = void 0;
const vscode = __importStar(require("vscode"));
class SecureGenDashboard {
    static panel;
    static show(context, status = 'Security engine ready') {
        ...
        this.panel = vscode.window.createWebviewPanel('secureGenDashboard', 'SecureGen • Security Center', column, { enableScripts: true, retainContextWhenHidden: true });
        this.panel.webview.html = this.html(status);
...
exports.SecureGenDashboard = SecureGenDashboard;
//# sourceMappingURL=secureGenDashboard.js.map