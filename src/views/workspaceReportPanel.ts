...
import { WorkspaceSecurityReport, Vulnerability } from '../types/vulnerability';

export class WorkspaceReportPanel {
    public static currentPanel: WorkspaceReportPanel | undefined;
    private readonly panel: vscode.WebviewPanel;
    private disposables: vscode.Disposable[] = [];

    public static createOrShow(extensionUri: vscode.Uri, report: WorkspaceSecurityReport) {
        ...
        const panel = vscode.window.createWebviewPanel(
            ...
            `🛡️ ${report.project.projectName} Security Report`,
            column,
            {
                enableScripts: true,
    ...
    private constructor(panel: vscode.WebviewPanel, report: WorkspaceSecurityReport) {
        this.panel = panel;
        this.update(report);
    ...
    public update(report: WorkspaceSecurityReport) {
    ...
    private getHtmlForWebview(report: WorkspaceSecurityReport): string {
